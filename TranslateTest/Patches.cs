...
{ 
    public class Patches
    {
        ...
        public class LocString_CreateLocStringKeys_Patch
        {
            public static void Prefix(System.Type type, string parent_path)
            {
                Debug.Log($"{ModInfo.Namespace}: LocString_CreateLocStringKeys_Patch.Prefix({type}, {parent_path})");
            }
            public static void Postfix(System.Type type, string parent_path)
            {
                Debug.Log($"{ModInfo.Namespace}: LocString_CreateLocStringKeys_Patch.Postfix({type}, {parent_path}) - seems OK");
            }
        }
