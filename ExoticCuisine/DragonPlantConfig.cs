...
namespace ExoticCuisine
{
    class DragonPlantConfig : IEntityConfig
    {
        ...
        public GameObject CreatePrefab()
        {
            ...
            EntityTemplates.ExtendEntityToBasicPlant(placedEntity, 228.15f, 278.15f, 308.15f, safe_elements: safeElements, crop_id: MushroomConfig.ID, max_radiation: 4600f, baseTraitId: "MushroomPlantOriginal", baseTraitName: ((string)STRINGS.PLANTS.DRAGONPLANT.NAME));
            ...
            EntityTemplates.CreateAndRegisterPreviewForPlant(EntityTemplates.CreateAndRegisterSeedForPlant(plant, SeedProducer.ProductionType.Harvest, SEED_ID, name2, desc2, anim2, numberOfSeeds: 0, additionalTags: additionalTags, replantGroundTag: replantGroundTag, sortOrder: 3, domesticatedDescription: domesticateddesc, width: 0.33f, height: 0.33f), "MushroomPlant_preview", Assets.GetAnim((HashedString)"fungusplant_kanim"), "place", 1, 2);
