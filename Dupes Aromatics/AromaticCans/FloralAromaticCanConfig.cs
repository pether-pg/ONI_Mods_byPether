...
namespace Dupes_Aromatics.AromaticCans
{
    class FloralAromaticCanConfig : IEntityConfig
    {
        ...
        public GameObject CreatePrefab()
        {
            ...
            GameObject looseEntity = EntityTemplates.CreateLooseEntity(ID, STRINGS.AROMATICCANS.FLORAL.NAME, STRINGS.AROMATICCANS.FLORAL.DESC, 1f, true, Assets.GetAnim("aromatic_rosescent_kanim"), "object", Grid.SceneLayer.Front, EntityTemplates.CollisionShape.RECTANGLE, 0.8f, 0.4f, true);
