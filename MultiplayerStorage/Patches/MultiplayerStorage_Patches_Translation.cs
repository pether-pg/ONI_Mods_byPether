    ...
    class ResearchRequirements_Patches_Translations
    {
        ...
        public class Localization_Initialize_Patch
        {
            ...
            public static void Translate(Type root)
            {
                ...
                Debug.Log($"MultiplayerStorage: using translation done by {STRINGS.TRANSLATION.AUTHOR.NAME}");
            }
            ...
            private static void LoadStrings()
            {
                ...
                Debug.Log($"MultiplayerStorage: Loading translation file: {path}");
                if (File.Exists(path))
                    OverloadStrings(LoadStringsFile(path, false));
                else
                    Debug.Log("MultiplayerStorage: Translation file not found, using default strings.");
            }
        }
    }
}
