...
namespace MultiplayerStorage
{
    class SharedStorageConfig : IBuildingConfig
    {
        ...
        public override BuildingDef CreateBuildingDef()
        {
            ...
            BuildingDef buildingDef = BuildingTemplates.CreateBuildingDef(ID, 1, 2, "multiverse_gate_kanim", 1000, 480f, construction_mass, construction_materials, 1600f, BuildLocationRule.OnFloor, tieR1, noise);
