...
{
    class TemporalReversalSickness : Sickness
    {
        // Sickness does not work, do not use
        public const string ID = nameof(TemporalReversalSickness);
        public const string RECOVERY_ID = "TemporalReversalSicknessRecovery";

        public TemporalReversalSickness()
            ...
            }, 2220f, RECOVERY_ID)
        {
            ...
            this.AddSicknessComponent((Sickness.SicknessComponent)new TemporalSicknessComponent(TemporalSicknessComponent.AnomalyMode.Reversal));
        }
    }
}
