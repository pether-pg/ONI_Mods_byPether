...
{
    class NanobotUpgrade_DurationBoostConfig : IEntityConfig, IHasDlcRestrictions
    {
        public const string ID = "NanobotUpgrade_DurationBoost";
        public const MutationVectors.Vectors VECTOR = MutationVectors.Vectors.Res_EffectDuration;
