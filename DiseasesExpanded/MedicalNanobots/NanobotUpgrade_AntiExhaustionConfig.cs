...
{
    class NanobotUpgrade_AntiExhaustionConfig : IEntityConfig, IHasDlcRestrictions
    {
        public const string ID = "NanobotUpgrade_AntiExhaustion";
        public const MutationVectors.Vectors VECTOR = MutationVectors.Vectors.Att_Stamina;
