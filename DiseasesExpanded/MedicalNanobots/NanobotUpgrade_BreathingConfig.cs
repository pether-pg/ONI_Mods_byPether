...
{
    class NanobotUpgrade_BreathingConfig : IEntityConfig, IHasDlcRestrictions
    {
        public const string ID = "NanobotUpgrade_Breathing";
        public const MutationVectors.Vectors VECTOR = MutationVectors.Vectors.Att_Breathing;
