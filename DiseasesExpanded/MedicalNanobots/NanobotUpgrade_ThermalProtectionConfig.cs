...
{
    class NanobotUpgrade_ThermalProtectionConfig : IEntityConfig, IHasDlcRestrictions
    {
        public const string ID = "NanobotUpgrade_ThermalProtection";
        public const MutationVectors.Vectors VECTOR = MutationVectors.Vectors.Res_TemperatureResistance;
