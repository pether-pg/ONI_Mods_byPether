...
namespace DiseasesExpanded
{
    class SapShotConfig : IEntityConfig
    {
        ...
        public const string EffectID = "SapShotEffect";
        ...
        public GameObject CreatePrefab()
        {
            ...
            SapShotConfig.recipe = new ComplexRecipe(ComplexRecipeManager.MakeRecipeID(ApothecaryConfig.ID, (IList<ComplexRecipe.RecipeElement>)ingredients, (IList<ComplexRecipe.RecipeElement>)results), ingredients, results)
            {
                time = 100f,
