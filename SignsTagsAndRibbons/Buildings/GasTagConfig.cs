...
namespace SignsTagsAndRibbons
{
    public class GasTagConfig : IBuildingConfig
    {
        ...
        public override BuildingDef CreateBuildingDef()
        {
            ...
            BuildingDef def = BuildingTemplates.CreateBuildingDef(ID, 2, 2, "gas_tag_kanim", 30, 10f, singleArray1, textArray1, 1600f, BuildLocationRule.Anywhere, decor, TUNING.NOISE_POLLUTION.NONE, 0.2f);
            def.Floodable = false;
        ...
        public override void DoPostConfigureComplete(GameObject go)
        {
            ...
            {
                "off", "art_a", "art_b", "art_c", "art_d", "art_e", "art_f", "art_g", "art_h", "art_i", "art_j", "art_l"
            };
        }
    }
}
