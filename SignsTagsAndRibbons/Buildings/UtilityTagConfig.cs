...
namespace SignsTagsAndRibbons
{
    public class UtilityTagConfig : IBuildingConfig
    {
        ...
        public override BuildingDef CreateBuildingDef()
        {
            ...
            BuildingDef def = BuildingTemplates.CreateBuildingDef(ID, 1, 1, "utility_tag_kanim", 30, 10f, singleArray1, textArray1, 1600f, BuildLocationRule.Anywhere, decor, TUNING.NOISE_POLLUTION.NONE, 0.2f);
            def.Floodable = false;
