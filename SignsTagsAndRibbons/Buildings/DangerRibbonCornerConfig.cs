...
{
    public class DangerRibbonCornerConfig : IBuildingConfig
    {
        public const string ID = "DangerRibbonCorner";
        ...
        public override BuildingDef CreateBuildingDef()
        {
            ...
            BuildingDef def1 = BuildingTemplates.CreateBuildingDef(ID, 1, 1, "tag_dangerribbon_corner_kanim", 30, 30f, singleArray1, textArray1, 1600f, BuildLocationRule.Anywhere, nONE, TUNING.NOISE_POLLUTION.NONE, 0.2f);
