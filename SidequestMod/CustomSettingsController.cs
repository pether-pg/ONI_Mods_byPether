...
#pragma warning restore IDE0051 // Remove unused private members
        ...
        private static CustomSettingsController _instance = null;
        public static CustomSettingsController Instance
        {
            get
            {
                if (_instance == null)
                {
                    ...
                    _instance = screen.AddOrGet<CustomSettingsController>();
                    _instance.Init();
        ...
        private void AddMissingCustomGameSetting(SettingConfig type)
        {
            ...
            Debug.Log(type.GetType().ToString() + " value not found, defaulting");
        ...
        private void SetCustomGameSettings(SettingConfig ConfigToSet, object valueId)
        {
            ...
            Debug.Log("changing " + ConfigToSet.id.ToString() + " from " + CustomGameSettings.Instance.GetCurrentQualitySetting(ConfigToSet).id + " to " + valueToSet.ToString());
        ...
        private void Init()
        {
            ...
            UIUtils.AddSimpleTooltipToObject(transform.Find("Content/Warning"), "CHANGEWARNINGTOOLTIP");
